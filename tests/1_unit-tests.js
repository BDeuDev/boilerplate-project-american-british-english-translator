...
suite('Unit Tests', () => {
    ...
    test('Translate Mangoes are my favorite fruit. to British English', () => {
        ...
        assert.equal(translator.translate(input, "american-to-british").translation, expected);
    });
    ...
    test('Translate We watched the footie match for a while. to American English', () => {
        ...
        assert.equal(translator.translate(input, "british-to-american").translation, expected);
    });
